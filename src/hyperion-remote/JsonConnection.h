...
public:
    ...
    ///
    void setColor(std::vector<ColorValue> color, int priority, int duration);
    ...
    /// @param duration The duration in milliseconds
    ///
    void setImage(std::string image, int priority, int duration);
...
private:
    ...
    ///
    Poco::Dynamic::Var sendMessage(const Poco::JSON::Object & message);
    ...
    ///
    bool parseReply(const Poco::Dynamic::Var & reply);
