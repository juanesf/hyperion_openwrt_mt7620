...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/home/buildbot/slave-local/ramips_mt7620/build/staging_dir/host/bin/grep -E"}
	: ${FGREP="/home/buildbot/slave-local/ramips_mt7620/build/staging_dir/host/bin/grep -F"}
	: ${GREP="/home/buildbot/slave-local/ramips_mt7620/build/staging_dir/host/bin/grep"}
	: ${SED="/home/buildbot/slave-local/ramips_mt7620/build/staging_dir/host/bin/sed"}
fi
